...
const VideoPage3 = () => {
  const videoUrl = "https://www.youtube.com/embed/_pOnIjq0qVo";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="v3" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
