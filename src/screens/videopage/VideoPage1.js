...
const VideoPage1 = () => {
  const videoUrl = "https://www.youtube.com/embed/Zu4f3CFrZ6I";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="v1" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
