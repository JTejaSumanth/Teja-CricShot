...
const VideoPage2 = () => {
  const videoUrl = "https://www.youtube.com/embed/zKo2vy4cjdo";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="v2" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
