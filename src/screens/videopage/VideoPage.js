...
const VideoPage = () => {
  const videoUrl = "https://www.youtube.com/embed/UxX4IQL03UU";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="v" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
