...
const Fast8 = () => {
  const videoUrl = "https://www.youtube.com/embed/D8bGC1cBl64";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast8" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
