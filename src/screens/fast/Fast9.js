...
const Fast9 = () => {
  const videoUrl = "https://www.youtube.com/embed/r-q5l0fVh3c";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast9" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
