...
const Fast1 = () => {
  const videoUrl = "https://www.youtube.com/embed/thh9JenH6zw";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast1" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
