...
const Fast7 = () => {
  const videoUrl = "https://www.youtube.com/embed/Ih7tt7sZqCQ";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast7" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
