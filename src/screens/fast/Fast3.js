...
const Fast3 = () => {
  const videoUrl = "https://www.youtube.com/embed/3M4mZFNitCQ";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title='fast3' frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
