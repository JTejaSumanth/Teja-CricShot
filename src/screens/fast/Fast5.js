...
const Fast5 = () => {
  const videoUrl = "https://www.youtube.com/embed/AA_z4wLEGCA";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast5" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
