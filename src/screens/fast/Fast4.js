...
const Fast4 = () => {
  const videoUrl = "https://www.youtube.com/embed/aO8zHpkeBuk";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast4" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
