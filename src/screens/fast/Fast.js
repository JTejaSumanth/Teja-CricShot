...
const Fast = () => {
  const videoUrl = "https://www.youtube.com/embed/dxWk8CXNDvY";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} frameborder="0" title="fast" allowFullScreen></iframe>
    </Video>
  );
};
