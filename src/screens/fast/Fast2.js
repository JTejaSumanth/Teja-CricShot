...
const Fast2 = () => {
  const videoUrl = "https://www.youtube.com/embed/699DgdDcAmk";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast2" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
