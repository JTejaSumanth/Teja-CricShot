...
const Fast6 = () => {
  const videoUrl = "https://www.youtube.com/embed/otVizFBlOK8";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="fast6" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
