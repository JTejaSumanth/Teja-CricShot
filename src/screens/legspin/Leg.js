...
const Leg = () => {
  const videoUrl = "https://www.youtube.com/embed/v-LGA7oxGJg";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="l" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
