...
const Leg3 = () => {
  const videoUrl = "https://www.youtube.com/embed/HdwgYTjvwXE";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="l3" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
