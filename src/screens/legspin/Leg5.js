...
const Leg5 = () => {
  const videoUrl = "https://www.youtube.com/embed/Oakd-xCgKs0";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="l5" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
