...
const Leg1 = () => {
  const videoUrl = "https://www.youtube.com/embed/C64WcUceFTo";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="l1" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
