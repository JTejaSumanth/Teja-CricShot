...
const Leg2 = () => {
  const videoUrl = "https://www.youtube.com/embed/DC2MOkpeYYs";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="l2" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
