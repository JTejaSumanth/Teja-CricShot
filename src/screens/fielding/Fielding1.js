...
const Fielding1 = () => {
  const videoUrl = "https://www.youtube.com/embed/1CNNuFwF53c";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="f1" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
