...
const Fielding = () => {
  const videoUrl = "https://www.youtube.com/embed/XZ8hJt99M4I";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="field" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
