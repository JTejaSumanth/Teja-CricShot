...
const Fielding2 = () => {
  const videoUrl = "https://www.youtube.com/embed/GJ27Zrn1yLs";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="f2" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
