...
const Orthodox4 = () => {
  const videoUrl = "https://www.youtube.com/embed/KLfmgX-0LtI";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or4" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
