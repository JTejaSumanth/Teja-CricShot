...
const Orthodox3 = () => {
  const videoUrl = "https://www.youtube.com/embed/ZlpUOPEknG4";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or3" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
