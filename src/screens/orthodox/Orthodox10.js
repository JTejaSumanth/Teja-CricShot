...
const Orthodox10 = () => {
  const videoUrl = "https://www.youtube.com/embed/ZpFlS8BTZfQ";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or10" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
