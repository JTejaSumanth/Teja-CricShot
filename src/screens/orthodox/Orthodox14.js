...
const Orthodox14 = () => {
  const videoUrl = "https://www.youtube.com/embed/OwCaUfMz_8g";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or14" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
