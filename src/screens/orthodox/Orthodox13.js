...
const Orthodox13 = () => {
  const videoUrl = "https://www.youtube.com/embed/0ZhXvTzVr0s";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or13" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
