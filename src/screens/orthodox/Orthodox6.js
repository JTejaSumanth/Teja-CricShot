...
const Orthodox6 = () => {
  const videoUrl = "https://www.youtube.com/embed/oFLkUnY1p6k";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or6" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
