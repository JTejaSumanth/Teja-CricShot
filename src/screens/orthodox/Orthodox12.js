...
const Orthodox12 = () => {
  const videoUrl = "https://www.youtube.com/embed/kAtrMpWiClw";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or12" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
