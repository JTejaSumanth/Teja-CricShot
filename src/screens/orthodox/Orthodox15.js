...
const Orthodox15 = () => {
  const videoUrl = "https://www.youtube.com/embed/7--nHWEqt_k";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or15" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
