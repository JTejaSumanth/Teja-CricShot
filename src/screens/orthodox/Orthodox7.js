...
const Orthodox7 = () => {
  const videoUrl = "https://www.youtube.com/embed/v3soFH5Jn68";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or7" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
