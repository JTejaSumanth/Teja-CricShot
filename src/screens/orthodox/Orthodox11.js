...
const Orthodox11 = () => {
  const videoUrl = "https://www.youtube.com/embed/9YNKX6_elTQ";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or11" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
