...
const Orthodox = () => {
  const videoUrl = "https://www.youtube.com/embed/h3N-BRQXTS4";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
