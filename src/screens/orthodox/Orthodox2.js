...
const Orthodox2 = () => {
  const videoUrl = "https://www.youtube.com/embed/ROw5OnbW1PE";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or2" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
