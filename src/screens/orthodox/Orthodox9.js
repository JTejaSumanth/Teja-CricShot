...
const Orthodox9 = () => {
  const videoUrl = "https://www.youtube.com/embed/K274tIBilOI";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or9" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
