...
const Orthodox8 = () => {
  const videoUrl = "https://www.youtube.com/embed/KYdy-eUZwP0";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or8" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
