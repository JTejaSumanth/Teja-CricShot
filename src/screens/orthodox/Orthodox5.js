...
const Orthodox5 = () => {
  const videoUrl = "https://www.youtube.com/embed/VAuatgBXwDA";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or5" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
