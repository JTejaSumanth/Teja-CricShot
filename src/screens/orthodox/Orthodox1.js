...
const Orthodox1 = () => {
  const videoUrl = "https://www.youtube.com/embed/WLs7YcH2V0w";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="or1" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
