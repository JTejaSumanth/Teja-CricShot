...
const Wk = () => {
  const videoUrl = "https://www.youtube.com/embed/oQHT4xysp3k";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="w" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
