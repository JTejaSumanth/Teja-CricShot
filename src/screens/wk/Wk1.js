...
const Wk1 = () => {
  const videoUrl = "https://www.youtube.com/embed/rL5QvGAOB9M";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="w1" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
