...
const Wk2 = () => {
  const videoUrl = "https://www.youtube.com/embed/SBlyekzhRKk";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="w2" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
