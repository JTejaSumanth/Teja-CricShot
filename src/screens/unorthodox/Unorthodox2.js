...
const Unorthodox2 = () => {
  const videoUrl = "https://www.youtube.com/embed/6EK4Er0PAx0";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="u2" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
