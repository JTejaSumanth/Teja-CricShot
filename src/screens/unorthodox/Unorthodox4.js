...
const Unorthodox4 = () => {
  const videoUrl = "https://www.youtube.com/embed/IkGNBNQTZiU";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="u4" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
