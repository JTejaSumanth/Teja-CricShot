...
const Unorthodox = () => {
  const videoUrl = "https://www.youtube.com/embed/sYkw-US0tEU";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="u" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
