...
const Off5 = () => {
  const videoUrl = "https://www.youtube.com/embed/zigprCjw_v4";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="o5" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
