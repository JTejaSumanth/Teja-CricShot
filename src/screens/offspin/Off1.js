...
const Off1 = () => {
  const videoUrl = "https://www.youtube.com/embed/ZIhv-2FywVo";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="o1" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
