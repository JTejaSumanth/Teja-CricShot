...
const Off = () => {
  const videoUrl = "https://www.youtube.com/embed/EjLVgi_HBus";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" src={videoUrl} title="o" frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
