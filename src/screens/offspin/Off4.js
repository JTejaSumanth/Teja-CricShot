...
const Off4 = () => {
  const videoUrl = "https://www.youtube.com/embed/DSmB046Nk2Q";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="o4" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
