...
const Off3 = () => {
  const videoUrl = "https://www.youtube.com/embed/WolAdUzvJJk";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="o3" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
