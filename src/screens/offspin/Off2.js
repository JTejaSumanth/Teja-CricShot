...
const Off2 = () => {
  const videoUrl = "https://www.youtube.com/embed/IOz1M4e05Hg";
  useEffect(() => {
  ...
  return (
    <Video>
      <iframe id="youtube-iframe" width="665" height="375" title="o2" src={videoUrl} frameborder="0" allowFullScreen></iframe>
    </Video>
  );
};
